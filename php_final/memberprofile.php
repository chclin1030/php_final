		...
		<div class="row">
			<div class="col-12 text-center">
				...
				<ol class="breadcrumb p-0 m-0">
				  <li class="breadcrumb-item"><a href="memberzone2.php">首頁</a></li>
	...
	<div class="container">
      ...
      <div class="block text-center">
        ...
        <?php
          ...
          echo "<table border='3' width='300' height='300'>";
          echo "<div class='text-align: center'>";
          echo "<tr><td><b>姓名</b></td><td>".$uname."</td></tr>";
          echo "<tr><td><b>帳號</b></td><td>".$uaccount."</td></tr>";
          echo "<tr><td><b>密碼</b></td><td>".$upwd."</td></tr>";
          echo "<tr><td><b>信箱</b></td><td>".$uemail."</td></tr>";
          echo "<tr><td><b>地址</b></td><td>".$uaddress."</td></tr>";
          echo "<tr><td><b>生日</b></td><td>".$ubirthday."</td></tr>";
          echo "<tr><td><b>手機</b></td><td>".$uphone."</td></tr>";
          echo "</div>";
          echo "</table>";
          echo "<br><div>";
          echo "<a href='update.php?uNo=".$uNo."'><button type='button' class ='btn btn-main-md'>資料修改</button></a>";
          echo "</div>";   
        ?>
			</div>
			</div>
