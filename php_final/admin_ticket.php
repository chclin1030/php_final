          ...
          <h2>訂票資訊</h2><br>
            <?php
              ...
              if($result=mysqli_query($link,$SQL)){
                ...
                echo "<tr><td><h6>訂單編號</h6></td><td><h6>活動編號</h6></td><td><h6>活動名稱</h6></td><td><h6>活動日期</h6></td><td><h6>活動時間</h6></td><td><h6>張數</h6></td><td><h6>訂購日期</h6></td><td><h6>繳費代碼</h6></tr>";
                while($row=mysqli_fetch_assoc($result)){
                  echo "<tr>";
                  echo "<td>".$row["tNo"]."</td><td>".$row["pNo"]."</td><td>".$row["pName"]."</td><td>".$row["pDate"]."</td><td>".$row["pTime"]."</td><td>".$row["tNum"]."</td><td>".$row["tDate"]."</td><td>".$row["tKey"]."</td>";
                  echo "</tr>";
                }
              }
                echo "</table>";
