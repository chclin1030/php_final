...
<nav class="navbar main-nav border-less fixed-top navbar-expand-lg p-0">
  <div class="container-fluid p-0">
      ...
      <a href="memberzone.php" class="ticket">
		...
		<div class="row">
			<div class="col-md-6 m-auto">
				<div class="block text-center">
					<img src="images/member.png" alt="404">
					<h3>Welcome to <span>Happy Ticket!!</span></h3>
          <a href="login.php" class="btn btn-main-md">登入</a>
					<a href="register.php" class="btn btn-main-md">立即註冊</a>
				</div>
			</div>
		</div>
	</div>
