...
<section class="section contact-form">
	<div class="container">
		...
		<form action="" method="post" class="row">
            ...
            <div class="col-md-12">
				您的信箱：<input type="email" class="form-control main" name="email" id="email" required="required">
			</div>
			<div class="col-md-12">
				您的意見：<input type="textarea" name="comment" id="comment" class="form-control main" >
			</div>
			<div class="col-12 text-center">
				<button type="submit" class="btn btn-main-md">傳送</button>
			</div>
		</form>
	</div>
</section>
  ...
  if(isset($_POST["email"])){
    if($_POST["email"] != null){
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST"){
        $SQL="INSERT INTO contactus (cMail,comment) VALUES ('$cMail','$comment')";
        if(mysqli_query($link,$SQL)){
          echo "<script type='text/javascript'>";
          echo "alert('我們已收到您的建議!');";
          echo "</script>";
