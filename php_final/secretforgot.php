...
<section class="section contact-form">
	<div class="container">
		...
		<form action="secretforgotconfirm.php" method="post" class="row">
			<div class="col-md-12">
				請輸入您的信箱：<input type="text" class="form-control main" name="uemail" id="uemail" placeholder="信箱" required="required">
			</div>
			<div class="col-md-12">
				請輸入您的帳號：<input type="password" class="form-control main" name="uaccount" id="uaccount" placeholder="帳號" required="required">
			</div>
			<div class="col-12 text-center">
				<button type="submit" class="btn btn-main-md" >尋找密碼</button>
			</div>
		</form>
	</div>
</section>
