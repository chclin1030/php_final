          ...
          <h2>訂票資訊</h2><br>
            <?php
              ...
              if($result=mysqli_query($link,$SQL)){
                ...
                echo "<tr><td><h6>表演名稱</h6></td><td><h6>表演日期</h6></td><td><h6>表演時間</h6></td><td><h6>張數</h6></td><td><h6>訂購日期</h6></td><td><h6>繳費代碼</h6></td><td><h6>修改張數</h6></td><td><h6>取消訂單</h6></td></tr>";
                while($row=mysqli_fetch_assoc($result)){
                  echo "<tr>";
                  echo "<td>".$row["pName"]."</td><td>".$row["pDate"]."</td><td>".$row["pTime"]."</td><td>".$row["tNum"]."</td><td>".$row["tDate"]."</td><td>".$row["tKey"]."</td><td><a href = 'ticket_update.php?tNo=".$row['tNo']."'><h6><u>修改</u></h6></td><td><a href = 'ticket_delete.php?tNo=".$row['tNo']."'><h6><u>取消</u></h6></td>";
                  echo "</tr>";
                }
              }
                echo "</table>";
